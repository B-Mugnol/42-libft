...
ft_strlen.c		ft_memset.c		ft_bzero.c		ft_memcpy.c		ft_memmove.c	ft_strlcpy.c	ft_strlcat.c	#ft_strchr.c		ft_strrchr.c	ft_strncmp.c	ft_memchr.c		ft_memcmp.c		ft_strnstr.c		ft_strdup.c
